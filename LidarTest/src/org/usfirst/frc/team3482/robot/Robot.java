...
import org.usfirst.frc.team3482.robot.subsystems.SimpleLIDAR;
...
public class Robot extends TimedRobot {
	...
	public void teleopInit() {
		...
		// RobotMap.pidtest.configSelectedFeedbackSensor(FeedbackDevice.QuadEncoder, 0,
		// 1);
	}
	...
	public void teleopPeriodic() {
		...
		//lidar.update(); // System.out.println("Distance (In): " + lidar.getDistance());
	}
